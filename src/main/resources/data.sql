...
CREATE TABLE IF NOT EXISTS Seance(id LONG PRIMARY KEY auto_increment, cinema_id LONG, film_id LONG, date_sceance DATE, nb_places INT);
INSERT INTO Seance(cinema_id, film_id, date_sceance) VALUES ( 0, 1, '2023-02-15', 200 );
INSERT INTO Seance(cinema_id, film_id, date_sceance) VALUES ( 1,3, '2022-02-01', 150 );
INSERT INTO Seance(cinema_id, film_id, date_sceance) VALUES ( 1, 1, '2022-02-01', 100 );
